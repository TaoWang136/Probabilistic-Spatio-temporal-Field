...
def compute_batch_statistics_test(prediction_output_dict,
                             dt,
                             max_hl,
                             ph,
                             node_type_enum,
    ...
    return prediction_dict,futures_dict,his###
    
    
    
#####我改进
    
def compute_batch_statistics_train(prediction_output_dict,
                         dt,
                         max_hl,
                         ph,
                         node_type_enum,
