...
class AdditiveAttention(nn.Module):
    ...
    def __init__(self, encoder_hidden_state_dim, decoder_hidden_state_dim, internal_dim=None):
        ...
        #print('加性注意力机制的输入',encoder_hidden_state_dim,decoder_hidden_state_dim,internal_dim)
    ...
    def forward(self, encoder_states, decoder_state):
        #print('输入状态',encoder_states.shape,decoder_state.shape)
        ...
        #print('注意力权重',final_context_vec.shape,attention_probs.shape)
