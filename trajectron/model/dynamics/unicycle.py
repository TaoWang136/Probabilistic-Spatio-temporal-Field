...
class Unicycle(Dynamic):
    ...
    def integrate_distribution(self, control_dist_dphi_a, x):
        ...
        log_pis = torch.clamp(control_dist_dphi_a.log_pis, min=-1e5)
        ...
        return GMM2D.from_log_pis_mus_cov_mats(control_dist_dphi_a.log_pis, pos_mus, pos_dist_sigma_matrix),pos_mus,sigmas,corrs,log_pis
